...
$("#FormSubmitButton").on("click", function () {
    ...
    var start = c_data["date"] + " " + c_data["startTime"];
    var end = c_data["date"] + " " + c_data["endTime"];


    var fileName = c_data["name"] + "_VirtualPlumberCall"

    console.log("Start ICS file creation");
    c_event = ics();
    ...
    console.log("start ICS download");

    c_event.download(fileName);

    console.log("end ICS download");
    return;
});
...
function data_snag() {
    ...
    var startTime = document.getElementById('custStartTime').value + " " + document.getElementById('custTimeAMPM').value;
    var endTime = end_time(startTime);
    desc = desc + "\n" + get_VPCall();
...
//calculate the end time for the meeting. Hardcoded at 30min call.
